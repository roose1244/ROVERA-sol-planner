...
def main():
    ...
    ap.add_argument("--no-three", action="store_true", help="skip Three.js")
    args = ap.parse_args()
    ...
    if not args.no_three:
        ...
        viz_three.render_three(elev, tclass, tau, top["route"], deposits,
                               start, save=args.out_three)
        print(f">> Wrote {args.out_three}")

    print(">> Writing live dashboard …")
    viz_dashboard.write("demo/dashboard.html")
    print(">> Wrote demo/dashboard.html  (auto-refreshes)")
